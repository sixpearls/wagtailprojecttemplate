...
apt-get install -y git fabric node-less
...
# Optional: install/upgrade Postgresql
...
su - vagrant -c "/usr/local/bin/virtualenv $VIRTUALENV_DIR && \
    ...
    PIP_DOWNLOAD_CACHE=/home/vagrant/.pip_download_cache $VIRTUALENV_DIR/bin/pip install -r $PROJECT_DIR/requirements/development.txt"
...
su - vagrant -c "cd $PROJECT_DIR && $VIRTUALENV_DIR/bin/python manage.py loaddata first_site_page.json"